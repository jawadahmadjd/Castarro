                ...
                key(cachedDestination) {
                    ...
                    when (cachedDestination) {
                        CastarroDestination.Home -> HomeScreen(
                            ...
                            onStartDesktopRemoteStream = onStartDesktopRemoteStream,
                            onStopDesktopRemoteStream = onStopDesktopRemoteStream,
                            onRestartDesktopRemoteStream = onRestartDesktopRemoteStream,
                            onRefreshDesktopRemoteStatus = onRefreshDesktopRemoteStatus,
                            onStreamProtectionAction = onStreamProtectionAction,
                            onScanSyncPairing = onScanSyncPairing,
                            onToggleDesktopVideoDownload = onToggleDesktopVideoDownload,
                            onStartDesktopVideoDownloads = onStartDesktopVideoDownloads,
                            onPauseDesktopVideoDownloads = onPauseDesktopVideoDownloads,
                            onResumeDesktopVideoDownloads = onResumeDesktopVideoDownloads,
                            onCancelDesktopVideoDownloads = onCancelDesktopVideoDownloads,
